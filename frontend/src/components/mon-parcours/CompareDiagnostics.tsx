        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 200 }}>
              <p style={{ margin: "0 0 6px", fontSize: 12, color: C.success, fontWeight: 600 }}>
                ✓ {t("compare_resolved")} ({result.blockers_resolved.length})
              </p>
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              <p style={{ margin: "0 0 6px", fontSize: 12, color: C.error, fontWeight: 600 }}>
                ⚠︎ {t("compare_new")} ({result.blockers_new.length})
              </p>
