...
/**
 * Minimal line-icon set (24×24, stroke-based) used across the site instead of
 * emoji — keeps the design consistent and intentional.
 */
const PATHS: Record<string, React.ReactNode> = {
  ...
  scale: (
    <>
      ...
      <path d="M7 21h10" />
      <path d="M12 3v18" />
      <path d="M3 7h4c2 0 4-1 5-1s3 1 5 1h4" />
    </>
  ),
  rocket: (
    <>
  ...
  presentation: (
    <>
      <path d="M2 4h20" />
      <path d="M3 4v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4" />
      <path d="M12 16v4" />
      <path d="M9 20h6" />
      <path d="M8 12l2.5-2.5L13 12l3-4" />
    </>
  ),
  shuffle: (
    <>
